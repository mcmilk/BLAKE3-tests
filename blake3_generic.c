...
static void hash_one_generic(const uint8_t *input, size_t blocks,
...
static void blake3_hash_many_generic(const uint8_t * const *inputs,
...
static boolean_t blake3_is_generic_supported(void)
{
	return (B_TRUE);
}
